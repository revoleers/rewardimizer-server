<?php
class Revoleers_Controller_Action extends Zend_Controller_Action
{
    ...
    public function searchAction()
    {
    	...
    	if ($request->isPost()) {
    		if ($this->_form->isValid($request->getPost())) {
		        ...
		        $offset = $request->getParam('offset', Revoleers_Model_Abstract::OFFSET);
		        $limit = $request->getParam('limit', Revoleers_Model_Abstract::LIMIT);
